...
def test_pseudorotation_roundtrip_diagnostic_bound(device='cpu'):
    """The analytic finite-branch builder must keep the global torsion error bounded."""
...
def test_no_legacy_or_numeric_solve_in_production_builder():
    """build_sugar_ring_closed_form must stay on the single analytic production path."""
    body = inspect.getsource(build_sugar_ring_closed_form)
    for banned in (
        '_solve_c2_azimuth',
        'build_ring_for_c2_azimuth',
        '_build_sugar_ring_finite_branch_debug',
